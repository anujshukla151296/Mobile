...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference("BankAccount.count") do
      post bank_accounts_url, params: { bank_account: { bank_account_number: @bank_account.bank_account_number, bank_holder_name: @bank_account.bank_holder_name } }, as: :json
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { bank_account_number: @bank_account.bank_account_number, bank_holder_name: @bank_account.bank_holder_name } }, as: :json
    assert_response :success
  end
